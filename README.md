...
flowchart TD
    ...
    subgraph Knowledge[Знания]
        Rules[(rules.yaml<br/>38 машинопроверяемых<br/>правил: 33 СП + 5 ENG)]
