...
Готовые примеры в репо: [docs/example_report.md](docs/example_report.md) — нормальный прогон, [docs/failed_example.md](docs/failed_example.md) — противоречивое ТЗ.
