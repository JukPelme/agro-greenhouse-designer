...
flowchart TD
    ...
    subgraph Knowledge[Знания]
        Rules[(rules.yaml<br/>25 машинопроверяемых<br/>правил: 20 СП + 5 ENG)]
