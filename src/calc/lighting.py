"""Supplemental lighting calculation — DLI-based approach."""
...
# Target DLI (mol/m²/day) per crop, source: Cornell CEA guides + Russian practice
...
# Crude PAR conversion: 1 MJ/m²/day of total solar ~ 2.0 mol/m²/day PAR
_PAR_FACTOR = 2.0
...
def compute_lighting(
    ...
    # Take weighted light transmittance of the envelope.
    growing_m2 = sum(b.floor_area_m2 for b in design.blocks)
    weighted_tau = sum(
        b.light_transmittance * b.floor_area_m2 for b in design.blocks
    ) / growing_m2
