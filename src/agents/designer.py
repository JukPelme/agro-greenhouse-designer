...
ТРИ ТИПА ТЕПЛИЦ (brief.greenhouse_type) — ОБЯЗАТЕЛЬНО ВЫБИРАЙ КОНСТРУКЦИЮ
ПОД УКАЗАННЫЙ ТИП:
- year_round (круглогодичная): полноценная капитальная конструкция, стекло
  или сотовый поликарбонат, высокий конёк ≥5,5 м для шпалерных культур,
  развитое отопление и досветка. Подсобки полные (котельная, склад,
  административно-бытовой, растворный узел).
- seasonal (сезонная): лёгкая конструкция, плёнка или поликарбонат, без
  зимнего отопления, без досветки. Конёк 3-4 м достаточно. Подсобки
  минимальные (тамбур, склад, бытовка). Эксплуатация апрель-октябрь.
- nursery (рассадная, школка): защита рассады от заморозков, конёк 3-3,5 м
  (низкорослые культуры), упрощённое отопление от -5°C весной, частичная
  досветка для всходов. Эксплуатация февраль-май. Стекло или поликарбонат.
...
THREE GREENHOUSE TYPES (brief.greenhouse_type) — MUST PICK CONSTRUCTION
TO MATCH THE REQUESTED TYPE:
- year_round: full capital structure, glass or honeycomb polycarbonate,
  tall ridge ≥5.5 m for trellis crops, full heating + supplemental
  lighting. Full auxiliary set (boiler, storage, admin/staff, nutrient mix).
- seasonal: light structure, film or polycarbonate, no winter heating,
  no supplemental lighting. Ridge 3-4 m is enough. Minimal aux (vestibule,
  storage, staff). Operates April-October.
- nursery (rassada / seedling school): protects seedlings from frost.
  Ridge 3-3.5 m (low-growing crops), light heating from -5°C in spring,
  partial supplemental for emergence. Operates February-May. Glass or
  polycarbonate cover.
