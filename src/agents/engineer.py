...
def engineer_node(state: GraphState) -> dict:
    ...
    water_result = water.compute_water_demand(design=design, crop=brief.target_crop, climate=climate)
    ...
    loads_result = structural.compute_loads(design=design, climate=climate)
